...
namespace QL_TOUR
{
    public partial class frmDatTour : Form
    {
        ...
        {
            KQSoTour();
            // Thay đổi màu cho button chuẩn
            btnTrongNuoc.BackColor = Color.MidnightBlue;
            btnTrongNuoc.ForeColor = Color.White;

            btnNgoaiNuoc.BackColor = Color.White;
        ...
        private void btnNgoaiNuoc_Click(object sender, EventArgs e)
        {
            KQSoTour();
            // Thay đổi màu cho button chuẩn
            btnNgoaiNuoc.BackColor = Color.MidnightBlue;
            btnNgoaiNuoc.ForeColor = Color.White;

            btnTrongNuoc.BackColor = Color.White;
        ...
        private void LoadData()
        {
            ...
            dgvTour.Columns[5].DefaultCellStyle.Format = "N0"; // Cột Giá Tour
        }
        ...
        {
            // DataGridView Rows.Count bao gồm cả dòng header mới nếu có, nên trừ 1 không chính xác
            // nếu AllowUserToAddRows là false. Dùng số dòng trong DataSource sẽ chính xác hơn.
            if (dgvTour.DataSource is DataTable dt)
            {
                lblKQSoTour.Text = "Đã tìm được " + dt.Rows.Count.ToString() + " tour";
            }
            else
            {
                lblKQSoTour.Text = "Đã tìm được 0 tour";
            }
        }
        ...
        private void btlLocKQ_Click(object sender, EventArgs e)
        {
            ...
            // Cập nhật lại số lượng tour sau khi lọc
            KQSoTour();
        }
    }
}